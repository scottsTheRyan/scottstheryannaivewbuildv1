      ...
      <div name='projects' className='w-full h-screen bg-[#FBFCFE] text-[#838384]'>
        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                ...
                <p className='py-4'>just getting started, more projects coming soon!!!  </p>
            </div>
            ...
            <div className='shadow-sm shadow-[#040c16] hover:scale-110 duration-500'>
                ...
                <div className='shadow-sm shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto' src={scrumptious} alt="To Do To Do" />
                    <p className='my-4'>Scrumptious Hardening</p>
                    <p className='my-4'>registration, authentication, authorization</p>
                    <div className='pt-2 text-center'>
